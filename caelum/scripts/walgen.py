...
wofi_css = Path.home() / ".config/wofi/style-wal.css"
...
# --- wofi colors generation (Waybar-style) ---
...
with open(wofi_css, "w") as f:
    f.write("/* Generated by walgen.py */\n")
    for k, v in wofi_colors.items():
        f.write(f"@define-color {k} {v};\n")

print("✅ Waybar, Fuzzel, SwayNC, Rofi, and Wofi color files updated.")
print(f"📄 Waybar: {waybar_css}")
print(f"📄 Fuzzel: {fuzzel_ini}")
print(f"📄 SwayNC: {swaync_css}")
print(f"📄 Rofi: {rofi_rasi}")
print(f"📄 Wofi: {wofi_css}")
